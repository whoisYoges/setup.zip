...
static const char *screenshot[] = { "/usr/bin/scrot", "$HOME/Pictures/Screenshots/screenshot.png", NULL };
static const char *areascreenshot[] = { "/usr/bin/scrot", "-s", "$HOME/Pictures/Screenshots/screenshot.png", NULL };
