...
static const unsigned int borderalpha = 200;
...
static const char *texteditor[]  = { "mousepad", NULL };
...
static const char *screenshot[] = { "scrot", "/home/invalid/Pictures/Screenshots/screenshot.png", NULL};
static const char *areascreenshot[] = { "scrot", "-s", "/home/invalid/Pictures/Screenshots/screenshot.png", NULL };
...
static Key keys[] = {
  ...
  { Mod4Mask, XK_v, spawn, {.v = volumecontrol} },
  { Mod4Mask, XK_n, spawn, {.v = networkmanager} },
  { Mod4Mask, XK_p, spawn, {.v = password_manager} },
};
